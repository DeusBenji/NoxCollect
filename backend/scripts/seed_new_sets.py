...
TARGET_SETS = ["Phantasmal Flames", "Chaos Rising"]
...
def main():
    print("Starting new sets seeder...")
    db = SessionLocal()
    
    # 1. Hardcode sets to bypass broken API endpoint
    matched_sets = [
        {"id": "me2", "name": "Phantasmal Flames", "series": "Mega Evolution"},
        {"id": "me4", "name": "Chaos Rising", "series": "Mega Evolution"}
    ]
    ...
    for api_set in matched_sets:
        ...
        print(f"Found {len(all_cards)} cards in {set_name}.")
        ...
        for api_card in all_cards:
            ...
            if img_url:
                ...
                ref_img.source_name = "pokemontcg.io API (Seeder)"
                db.commit()
